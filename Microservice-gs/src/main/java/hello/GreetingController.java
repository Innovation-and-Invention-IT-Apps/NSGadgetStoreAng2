...
public class GreetingController {
    ...
    public String processCart(@RequestParam(value="Cart") String itemsList,
    		@RequestParam(value="email") String email) {
	    System.out.println("Cart ITEMS: " + itemsList + ", UserID: " + email);
        //return ProcessCart.sendMail(itemsList, email);
